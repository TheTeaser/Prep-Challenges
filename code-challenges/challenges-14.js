...
const LastWord = (str) => {
    ...
    let lastWord=str.slice(lastSpace+1);
    return lastWord
}
// -------------------------------------------------------------------------------------------------------
...
const replaceWords = (str) => {
    ...
    let wordsWithI= splitWords.lastIndexOf("I");
    if (wordsWithI!==-1){splitWords.splice(wordsWithI,1, "We");}

    let wordsWithAm = splitWords.lastIndexOf("am");
    if (wordsWithAm!==-1){splitWords.splice(wordsWithAm,1, "are");}

    let wordsWithWas = splitWords.lastIndexOf("was");
    if (wordsWithWas!==-1){splitWords.splice(wordsWithWas,1, "were");}

    let newWords= splitWords.join(' ');
    return newWords
